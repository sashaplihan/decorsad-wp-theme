...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'settings'        => array(
        ...
        array(
            'id'          => 'header_phone_list_item',
            'label'       => 'Телефон',
            'desc'        => 'Нажмите кнопку "Добавить" и заполните поля данными',
            'type'        => 'list-item',
            'section'     => 'header',
            'settings'    => array(
                array(
                ...
                array(
                    'id'          => 'phone_provider',
                    'label'       => 'Название оператора сотовой связи',
                    'desc'        => 'Введите название оператора сотовой связи',
                    'type'        => 'text',
                ),
            )
        ),
        ...
        array(
            ...
            'settings'    => array(
                ...
                array(
                    ...
                    'desc'        => 'Введите ссылку на социальную сеть',
                    'type'        => 'text',
                ),
            )
        ),
        ...
        array(
            'id'           => 'footer_name_contact_block',
            'label'        => 'Название блока контактной информации',
            'desc'         => 'Введите название блока контактной информации',
            'type'         => 'text',
            'section'      => 'footer',
        ),
        array(
            'id'           => 'footer_icon_contact_block_1',
            'label'        => 'Иконка Font Awesome',
            'desc'         => 'Вставьте css класс иконки (например: fa-phone), посмотреть можно <a href="https://fontawesome.ru/cheatsheet/" target="_blank">здесь</a>.',
            'type'         => 'text',
            'section'      => 'footer',
        ...
        array(
            'id'           => 'footer_info_contact_block_1',
            'label'        => 'Контактная информация',
            'desc'         => 'Введите введите контактную информацию',
            'type'         => 'text',
            'section'      => 'footer',
        ),
        array(
        ...
        array(
            'id'           => 'year_foundation_org',
            'label'        => 'Год основания юридического лица',
            'desc'         => 'Введите год основания юридического лица',
            'type'         => 'text',
            'section'      => 'footer',
        ),
        array(
            ...
            'desc'         => 'Введите название юридического лица',
            'type'         => 'text',
            'section'      => 'footer',
        ),
        array(
        ...
        array(
            ...
            'label'        => 'Название блока правого футера',
            'desc'         => 'Введите название блока правого футера',
            'type'         => 'text',
            'section'      => 'footer',
        ),
        array(
            'id'          => 'footer_right_block_textblock',
            'label'       => __( 'Textblock', 'theme-text-domain' ),
            'desc'        => 'В виджетах нужно добавить нужный виджет в footer_right_sidebar и настроить его',
            'std'         => '',
            'type'        => 'textblock',
            'section'     => 'footer',
        ),
        ...
        array(
            'id'          => '404_page_title',
            'label'       => 'Заголовок для 404 страницы',
            'desc'        => 'Введите заголовок для 404 страницы',
            'type'        => 'text',
            'section'     => '404_page',
        ),
        array(
            'id'          => '404_page_subtitle',
            'label'       => 'Подзаголовок для 404 страницы',
            'desc'        => 'Введите подзаголовок для 404 страницы',
            'type'        => 'text',
            'section'     => '404_page',
        ),
        array(
            'id'          => '404_page_content',
            'label'       => 'Описание для 404 страницы',
            'desc'        => 'Введите описание для 404 страницы',
            'type'        => 'text',
            'section'     => '404_page',
        ),
        array(
            'id'          => '404_page_name_link',
            'label'       => 'Текст ссылки для 404 страницы',
            'desc'        => 'Введите текст ссылки для 404 страницы',
            'type'        => 'text',
            'section'     => '404_page',
        ),
        array(
            'id'          => '404_page_link',
            'label'       => 'Ссылка для 404 страницы',
            'desc'        => 'Введите адрес ссылки для 404 страницы',
            'type'        => 'text',
            'section'     => '404_page',
        ),
